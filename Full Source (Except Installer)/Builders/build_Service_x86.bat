@echo off
REM ============================================================================
REM Builds NutriculaLicenseService32.exe using Dev-C++'s MinGW/g++.
REM
...
%GPP32% -m32 -std=c++17 -O2 -static-libgcc -static-libstdc++ ^
...
echo BUILD SUCCEEDED: %OUT_DIR%\NutriculaLicenseService32.exe
