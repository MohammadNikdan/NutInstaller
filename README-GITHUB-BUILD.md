...
Assets/Nutricula.ex4.sig
Assets/Nutricula.ex5.sig
Assets/MathUtils.dll
```

The five files under `Assets` are compiled into the installer as embedded .NET resources. They are **not** copied beside the final EXE.
...
3. Confirm the six required files exist at the exact paths above.
...
The generated installer is a single application EXE containing the five Nutricula product binaries as embedded resources. .NET Framework 4.8 itself remains an operating-system/runtime prerequisite and is not embedded into this EXE.
